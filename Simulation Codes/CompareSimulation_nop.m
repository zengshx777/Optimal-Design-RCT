...
function [ATE,ATE_1,ATE_2,ATE_3,ATE_4,V_ATE,VR_ATE,VB_ATE,VMM_ATE,VMR_ATE,numberre,run_time] =CompareSimulation_nop(simu_number,N_samplesize,N_covariate,normal,p,t,h1,h2,linear,boottime)
...
[ATE_2(i),b_ATE_2,run_time(i)]=Optimalb(b_number);
%Matching Method
